...
class CharCorruptionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        avg_masked_length = len(truncated_document) // 4
        masked_length = random.randint(0, avg_masked_length * 2)
        ...
        # Encode the strings as Long tensors
