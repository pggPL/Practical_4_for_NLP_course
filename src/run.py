...
if args.function == 'pretrain':
    ...
    pretrainer = trainer.Trainer(gpt_model, pretrain_dataset, None, tconf)
    ...
    fine_trainer = trainer.Trainer(gpt_model, finetune_dataset, None, tconf)
    fine_trainer.train()
